...
export function ExperimentalOutline() {
    return (
...
export function ExperimentalSolid() {
    return (
        <svg width="1em" height="1em" viewBox="0 0 1024 1024">
            <path
                fill="currentColor"
